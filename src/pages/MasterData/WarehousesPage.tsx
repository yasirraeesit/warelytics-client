  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h2 className="text-2xl font-extrabold tracking-wide">Warehouses</h2>
          <div className="text-sm text-white/70">Manage warehouse master data.</div>
        </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
        <h3 className="mb-3 text-lg font-bold">Create warehouse</h3>
        <div className="grid grid-cols-12 gap-3">
          ...
          <div className="col-span-12 md:col-span-8">
            ...
            <input
              ...
              placeholder="e.g. Karachi Main Warehouse"
            />
      ...
      <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
        <div className="overflow-auto rounded-2xl border border-white/10">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {(data?.items ?? []).map((w) => (
                <tr key={w.id} className="odd:bg-white/[0.02] hover:bg-purple-500/5">
                  <td className="border-b border-white/10 p-3">
                    <code>{w.code}</code>
                  </td>
                  <td className="border-b border-white/10 p-3">{w.name}</td>
